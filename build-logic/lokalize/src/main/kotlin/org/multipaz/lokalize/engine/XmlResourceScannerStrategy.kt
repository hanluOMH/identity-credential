...
/**
 * XML resource scanner strategy.
 * Parses Android strings.xml files and extracts all resource types.
 *
 * Supports:
 ...
 */
class XmlResourceScannerStrategy : ResourceScannerStrategy {
    ...
    override fun supports(file: File): Boolean {
        return file.exists() && file.name.endsWith(".xml", ignoreCase = true)
    }
