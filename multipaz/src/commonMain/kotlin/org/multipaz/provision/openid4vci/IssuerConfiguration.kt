...
internal data class IssuerConfiguration(
    ...
    companion object: JsonParsing("Issuer metadata") {
        ...
        suspend fun get(url: String, clientPreferences: ClientPreferences): IssuerConfiguration {
        ...
        private fun extractKeyProofType(
            ...
            if (proof != null) {
                ...
                return if (attestation != null) {
                    KeyProofType.Attestation(alg)
                } else {
                    KeyProofType.ProofOfPossession(alg)
                }
            }
